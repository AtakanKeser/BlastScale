 ...
 *
 * <pre>
 *   ZINCRBY  lb:weekly:2026-W20  {score}  {playerId}     -- on every level completion, O(log N)
 *   ZREVRANGE lb:weekly:2026-W20 0 99 WITHSCORES         -- top 100
 *   ZREVRANK  lb:weekly:2026-W20 {playerId}              -- my rank
 * </pre>
 *
...
public class LeaderboardService {
    ...
    public FinalizationResult finalizeSeason(String season, boolean force) {
        if (!LeaderboardSeason.isValid(season)) {
            throw new BlastScaleException(ErrorCode.VALIDATION_ERROR, "Season must look like 2026-W20");
        }
